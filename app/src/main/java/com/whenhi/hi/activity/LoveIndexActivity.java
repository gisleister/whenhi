...
public class LoveIndexActivity extends BaseActivity{
    ...
    private static final String TAG =LoveIndexActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_love_index);
    ...
    private void initView(Bundle savedInstanceState){
        ...
        mFragmentNavigator = new FragmentNavigator(getSupportFragmentManager(), mOtherFragmentAdapter, R.id.fragment_other_love_container);
    ...
    private void setDefaultFrag() {
        mFragmentNavigator.showFragment(Constants.OTHER_LOVE_INDEX);
