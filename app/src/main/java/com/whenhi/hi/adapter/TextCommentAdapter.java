...
public class TextCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TextCommentAdapter(Feed feed) {
        mFeed = feed;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (type) {
            ...
            case TYPE_CHILD:
                itemView = inflate(viewGroup, R.layout.item_text_comment);
