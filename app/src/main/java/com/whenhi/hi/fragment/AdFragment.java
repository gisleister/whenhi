...
import com.whenhi.hi.adapter.AdCommentAdapter;
import com.whenhi.hi.adapter.WebViewCommentAdapter;
...
public class AdFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener,OnChildItemClickListener<Comment> {
    ...
    private AdCommentAdapter mAdapter;
    ...
    public static AdFragment newInstance(Feed feed) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new AdCommentAdapter(mFeed);
    }
