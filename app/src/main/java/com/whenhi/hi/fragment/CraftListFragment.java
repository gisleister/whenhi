 ...
 */
public class CraftListFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener,
    ...
    public static CraftListFragment newInstance() {
        CraftListFragment fragment = new CraftListFragment();
        return fragment;
    }

    public CraftListFragment() {
    ...
    public void onLoadMore() {
        ...
        HttpAPI.craftList(mExtras,mPageNo, new HttpAPI.Callback<FeedModel>() {
            @Override
