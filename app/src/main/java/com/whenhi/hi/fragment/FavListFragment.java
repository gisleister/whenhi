 ...
 */
public class FavListFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener,
        OnItemClickListener<Feed>,
        OnItemLongClickListener<Feed> {
    private static final String TAG = FavListFragment.class.getSimpleName();
    ...
    public void onLoadMore() {
        mPageNo++;
        HttpAPI.favList(mExtras,mPageNo, new HttpAPI.Callback<FeedModel>() {
            @Override
