...
public class LoveIndexFragment extends BaseFragment implements OnItemClickListener<Feed>, OnItemLongClickListener<Feed> {
    ...
    public static Fragment newInstance(List<Feed> feeds) {
        mFeeds = feeds;
        LoveIndexFragment fragment = new LoveIndexFragment();
        return fragment;
    }

    public LoveIndexFragment() {
