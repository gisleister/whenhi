...
public class PicFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener,OnChildItemClickListener<Comment> {
    ...
    public static PicFragment newInstance(Feed feed) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new PicCommentAdapter(mFeed);
    }
