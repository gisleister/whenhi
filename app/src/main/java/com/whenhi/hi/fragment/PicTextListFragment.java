 ...
 */
public class PicTextListFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener,
    ...
    public static Fragment newInstance() {
        PicTextListFragment fragment = new PicTextListFragment();
        return fragment;
    }
    ...
    public void onLoadMore() {
        ...
        HttpAPI.requestList("pictext",App.getExtras("pictext"),mPageNo, new HttpAPI.Callback<FeedModel>() {
            @Override
            public void onSuccess(FeedModel feedModel) {
                mSwipeToLoadLayout.setLoadingMore(false);
                if(feedModel.getState() == 0){
                    App.setExtras("pictext",feedModel.getData().getExtras());
