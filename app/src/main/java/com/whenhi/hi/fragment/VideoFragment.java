...
public class VideoFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener,OnChildItemClickListener<Comment> {
    ...
    public static VideoFragment newInstance(Feed feed, Activity activity) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new VideoCommentAdapter(mFeed,mActivity);
    }
