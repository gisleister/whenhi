...
public class WebViewFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener,OnChildItemClickListener<Comment> {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new WebViewCommentAdapter(mFeed);
    }
